...
export async function getServerSideProps(){
  /* here we check to see the current enviornment variable */
  /* and render a provider based on the envoirnment we're in */
  let provider 
  if(process.env.Enviornment === 'local') {
    provider = new ethers.providers.JsonRpcProvider()
  } else if (process.env.ENVOIRNMENT === 'testnet') {
  ...
  border-radious: 15px;
  cursor: pointer;
  box-shadow: 7px 7px rgba(o, o, o, .1);
  `

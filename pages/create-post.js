...
/* configue the markdown editor to be client-side import */
        ...
        onChange={value => setPost({ ...post, content: value})}
         />
         {
             loaded && (
                 ...
                 className={button}
                 type='button'
                 onClick={createNewPost}>Publish</button>
                 <button onClick={triggerOnChange}
                 className={button}>Add cover image</button>
                 </>
             )
         }
